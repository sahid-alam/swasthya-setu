...
const STRINGS = {
  EN: {
    ...
    switchLang: "हिन्दी",
    talkToAgent: "Book by speaking",
    endCall: "End call",
    voiceReady: "Ready",
    voiceConnecting: "Connecting",
    voiceListening: "Listening",
    voiceEnded: "Call ended",
    voiceFailed: "Call failed",
    voiceFailedHelp: "The call did not work. You can still book below.",
    orBookByTapping: "Or choose a time yourself",
    signIn: "Sign in",
    signOut: "Sign out",
  ...
  HI: {
    ...
    switchLang: "English",
    talkToAgent: "बोलकर बुक करें",
    endCall: "कॉल समाप्त करें",
    voiceReady: "तैयार",
    voiceConnecting: "जोड़ा जा रहा है",
    voiceListening: "सुन रहे हैं",
    voiceEnded: "कॉल समाप्त",
    voiceFailed: "कॉल नहीं हो पाई",
    voiceFailedHelp: "कॉल नहीं हो पाई। आप नीचे से बुक कर सकते हैं।",
    orBookByTapping: "या खुद समय चुनें",
    signIn: "साइन इन करें",
    signOut: "साइन आउट",
